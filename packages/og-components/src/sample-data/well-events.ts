...
export const sampleWellEvents: WellEvent[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      steps: [
        { time: "Aug 30", label: "Rigged up workover rig; killed well" },
        { time: "Aug 31", label: "Pulled rod string — parted at 4,210 ft" },
        { time: "Sep 2", label: "Pulled tubing; inspected — no leaks" },
        { time: "Sep 5", label: "Fished retained rod section" },
        { time: "Sep 8", label: "Ran new insert pump + 18 replacement rods" },
        { time: "Sep 10", label: "Ran tubing; pressure-tested to 1,500 psi" },
        { time: "Sep 12", label: "Returned to production at 705 BOE/d" },
      ],
    },
