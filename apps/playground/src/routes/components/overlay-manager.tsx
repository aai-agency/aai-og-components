    ...
    >
      <DemoCard title="Usage">
        <div className="p-6 text-sm text-muted-foreground space-y-3">
          <p>
            The OverlayManager is used as part of the Map component when{" "}
            <code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">enableOverlayUpload</code> is enabled. It
            provides drag-and-drop file upload, per-overlay style editing, and feature inspection.
          </p>
          <p>
            See the{" "}
            <a href="/components/map" className="text-foreground underline underline-offset-4">
              Map
            </a>{" "}
            demo for a live example with overlays enabled.
          </p>
        </div>
      </DemoCard>
      ...
      <PropTable
        props={[
          ...
          {
            name: "onStyleChange",
            type: "(id: string, style: OverlayStyle) => void",
            description: "Style change callback",
          },
